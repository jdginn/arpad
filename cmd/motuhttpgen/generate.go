...
func generateRootStruct(n *Node, w io.Writer) {
	...
	fmt.Fprintf(w, "type Motu struct {\n")
	fmt.Fprintf(w, "    d      *HTTPDatastore\n")
	...
	fmt.Fprintf(w, "func NewMotu(datastore *HTTPDatastore) *Motu{\n")
	fmt.Fprintf(w, "    return &Motu{\n")
	fmt.Fprintf(w, "        d: datastore,\n")
